...
public class StudentsDeliveredCursorAdapter extends
        RecyclerView.Adapter<StudentsDeliveredCursorAdapter.StudentsViewHolder> {
    ...
    private StudentsDeliveredActivity mParentActivity;
     ...
     */
    public StudentsDeliveredCursorAdapter(Context mContext, StudentsDeliveredActivity parent, boolean mTwoPane) {
    ...
    public void onBindViewHolder(StudentsViewHolder holder, int position) {
        ...
        int idIndex = mCursor.getColumnIndex(AssignmentStudentContract.AssignmentsStudentsEntry._ID);
        ...
        String studentName = mCursor.getString(studentNameIndex);
